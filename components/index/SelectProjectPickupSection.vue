<template>
  <div ref="Pickup" class="pickup is-pickup-scene-00">
    ...
    <span
      ...
      :style="pickupData[0] ? `background-color:${pickupData[0].siteColor.bodyContentsColor};` : ''"
    ></span>
    <span class="pickup-circle-bg-area">
      <AppCircleBg v-if="pickupData[1]" :state="isCircleBgState02" :modifier="'pickup-02'" :color="pickupData[1].siteColor.bodyContentsColor" />
      <AppCircleBg v-if="pickupData[2]" :state="isCircleBgState03" :modifier="'pickup-03'" :color="pickupData[2].siteColor.bodyContentsColor" />
    </span>
    <!--シーンごとのセクションナンバー-->
