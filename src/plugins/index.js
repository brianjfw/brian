...
export async function setupPlugins() {
  ...
  try {
    ...
    // Wait a tick to ensure plugins are registered
    ...
    try {
      ...
      console.error('Failed to create custom easing:', error)
      // Provide fallback easing
      EASING = {
        transform: 'power2.out',
        transformReverse: 'power2.inOut',
        colorAndOpacity: 'power2.inOut',
      }
    }
